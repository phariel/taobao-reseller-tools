...
app.get('/products/onsale', function (req, res) {
  res.redirect('/products/onsale/1')
});
app.get('/products/inventory', function (req, res) {
  res.redirect('/products/inventory/1')
});
app.get('/products/onsale/:page', products.onsale);
app.get('/products/inventory/:page', products.inventory);
